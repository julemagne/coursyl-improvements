...
class TermsControllerTest < ActionController::TestCase
  ...
  test "should create term" do
    assert_difference('Term.count') do
      post :create, term: { ends_on: @term.ends_on, name: @term.name, school_id: @term.school_id, starts_on: @term.starts_on }
    end
  ...
  test "should update term" do
    patch :update, id: @term, term: { ends_on: @term.ends_on, name: @term.name, school_id: @term.school_id, starts_on: @term.starts_on }
    assert_redirected_to term_path(assigns(:term))
  end
